...
@Component({
  ...
  styles: [`
    ...
    .billing-card {
      position: relative;
      background: var(--background-tertiary-color, var(--bg-card-hover));
      border: 2px solid var(--border-theme-color, var(--border-color));
    ...
    .tier-card {
      ...
      &.selected {
        box-shadow: 0 4px 14px var(--primary-glow, rgba(239, 68, 68, 0.25));
    ...
    .tier-badge {
      ...
      border-radius: var(--radius-pill);
      box-shadow: 0 2px 8px var(--primary-glow, rgba(239, 68, 68, 0.4));
    }
